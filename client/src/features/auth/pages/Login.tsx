...
export default function Login() {
    ...
    return (
        <div className="flex min-h-screen flex-col items-center justify-center bg-[linear-gradient(135deg,#e8edf5_0%,#f0f4fb_50%,#e4eaf4_100%)] [font-family:'Segoe_UI',system-ui,sans-serif]">
            <div className="mb-8 flex flex-col items-center">
                ...
                <h1 className="text-2xl font-bold tracking-tight text-[#1e293b]">Construction Compliance</h1>
                <p className="mt-1 text-sm text-[#64748b]">Municipal Inspection Portal</p>
            </div>
            ...
            <div className="w-full max-w-[380px] rounded-2xl bg-white p-8 shadow-[0_4px_24px_rgba(0,0,0,0.06)]">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <p className="mt-4 text-center text-[0.8rem] text-[#94a3b8]">Authorized personnel only</p>
                </form>
            </div>

            <p className="mt-8 text-xs text-[#94a3b8]">© 2026 Municipal Construction Compliance System</p>
        </div>
    )
}
